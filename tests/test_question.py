...
class TestQuestion:
    ...
    def test_question_price(self, driver):
        ...
        assert main_page.get_answer_question_price() == answers[0]
    ...
    def test_question_few_scooter(self, driver):
        ...
        assert main_page.get_answer_question_few_scooter() == answers[1]
    ...
    def test_question_rental_period(self, driver):
        ...
        assert main_page.get_answer_question_rental_period() == answers[2]
    ...
    def test_question_today_order(self, driver):
        ...
        assert main_page.get_answer_question_today_order() ==  answers[3]
    ...
    def test_question_change_period(self, driver):
        ...
        assert main_page.get_answer_question_change_period() == answers[4]
    ...
    def test_question_charge(self, driver):
        ...
        assert main_page.get_answer_question_charge() == answers[5]
    ...
    def test_question_cancel(self, driver):
        ...
        assert main_page.get_answer_question_cancel() == answers[6]
    ...
    def test_question_county(self, driver):
        ...
        assert main_page.get_answer_question_county() == answers[7]